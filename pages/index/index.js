Page({
  data: {
    ...
    pains: [
      '用户向 AI 寻找产品或品牌推荐时，AI 没有提到你',
      'AI 提到了品牌，但业务、优势或联系方式说错了',
      '竞品被优先推荐，你的品牌缺少可引用的信任证据'
    ],
    abilities: [
      '品牌识别',
      '主动推荐',
    ...
    services: [
      {
        tag: '体验',
        title: '品牌 AI 可见度体验',
        desc: '适合第一次了解品牌是否被 AI 识别、是否被推荐。'
      },
      {
        tag: '快检',
        title: 'AI 可见度快检',
        desc: '五平台基础测试、核心问题、基础评分与报告解读。'
      },
      {
        tag: '全景',
        title: 'GEO 全景诊断',
        desc: '覆盖品牌档案、关键词、热门问题、竞品与信源诊断。'
      }
    ],
